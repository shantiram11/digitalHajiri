 ...
 */
final class AttendanceRuleController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        return response()->json([
            'data' => AttendanceRule::query()->latest('id')->paginate($request->integer('per_page', 25)),
        ]);
    }

    public function show(int $id): JsonResponse
    {
        return response()->json(['data' => AttendanceRule::query()->findOrFail($id)]);
    }
}
